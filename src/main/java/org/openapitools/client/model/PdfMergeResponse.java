 ...
 */
@ApiModel(description = "Represents the response to a merge action request.")
...
public class PdfMergeResponse {
  ...
  public PdfMergeResponse error(Error error) {
  ...
  **/
  ...
  public PdfMergeResponse remainingTokens(Long remainingTokens) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the file identifier of the merged document.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PdfMergeResponse pdfMergeResponse = (PdfMergeResponse) o;
    return Objects.equals(this.error, pdfMergeResponse.error) &&
        Objects.equals(this.remainingTokens, pdfMergeResponse.remainingTokens) &&
        Objects.equals(this.fileId, pdfMergeResponse.fileId);
  }
